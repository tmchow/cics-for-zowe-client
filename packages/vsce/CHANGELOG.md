...
- Enhancement: Datasets, USS and logs will have hyperlink in RI highlights. [#621](https://github.com/zowe/cics-for-zowe-client/issues/621)
...
- Enhancement: Allow extender actions to be removed with Disposable returned from registration. [#592](https://github.com/zowe/cics-for-zowe-client/issues/592)
...
- Enhancement: Added CICS Bundle and Bundle Part resources to the CICS tree.
- Enhancement: Added new "Inspect CICS Resource" command to quickly view CICS resource information. [#281](https://github.com/zowe/cics-for-zowe-client/issues/281)
